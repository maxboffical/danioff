...
async def _(e):
    ...
    await e.reply('✘ 𝙺𝚊𝚛𝚖𝚊 𝚂𝚢𝚜𝚝𝚎𝚖 𝙸𝚜 𝙾𝚗𝚕𝚒𝚗𝚎\n\n✘ 𝚂𝚒𝚗𝚌𝚎: `{}`'.format(uptime), file= 'https://telegra.ph/file/99c4658f9fdbaa00d0aa3.mp4', buttons=[[Button.url('**Sᴜᴘᴘᴏʀᴛ**', 'https://t.me/karma_appeal'),Button.url('**Lᴏɢs**', 't.me/karma_gbanlogs')], [Button.url('**Sᴄᴀɴɴᴇʀ**','t.me/Karma_scanner')]])
...
async def inline_handler(event):
    ...
    if event.query.user_id not in INSPECTORS:
        result = builder.article(
            "Karma System", text="You don't have access to this cmd."
        )
