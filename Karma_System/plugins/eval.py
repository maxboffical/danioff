...
@System.on(system_cmd(pattern=r"Karma (exec|execute|x|ex)"))
async def run(event):
...
@System.on(system_cmd(pattern=r"Karma (ev|eva|eval|py)"))
...
EXAMPLE - `!Karma x print("OWO")`
Run code using **eval**
CMD - <ev or eva or eval or py> your code
EXAMPLE - `!Karma eval 1 + 1`
"""
