...
from Karma_System.plugins.Mongo_DB.gbans import update_gban, delete_gban


class KarmaClient(TelegramClient):
    """KarmaClient - Subclass of Telegram Client."""

    def __init__(self, *args, **kwargs):
        """Declare stuff."""
        self.gban_logs = GBAN_MSG_LOGS
        self.approved_logs = Karma_approved_logs
        self.log = Karma_logs
        self.bot = None
        self.processing = 0
        self.processed = 0
